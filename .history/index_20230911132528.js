...
app.get('/', restaurantRoute.get); // For showing tables that can be booked
app.post('/book', restaurantRoute.book); // For booking a table
app.get('/bookings', restaurantRoute.getAllBookings); // For showing all bookings
app.get('/bookings/:username', restaurantRoute.getUserBookings); // For showing bookings by a user
app.post('/cancel', restaurantRoute.cancelBooking); // For canceling a booking
