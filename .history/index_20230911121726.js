...
const connection = {
    connectionString: process.env.THE_VARIABLE_NAME_HERE,  // Replace with the actual environment variable
    ssl: { rejectUnauthorized: false },
  };
  
  if (!connection.connectionString) {
    console.error("Database connection string is not set in env variables. Shutting down...");
    process.exit(1);
  }
